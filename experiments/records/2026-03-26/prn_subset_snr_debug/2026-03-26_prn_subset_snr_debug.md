...
|---------|------------|------------|-------------|-------------|------|
| 35 dB   | 4.7 | 4.4 | 5.1 | 4.6 | ✅ 通过（stem: `20260326_163251_...`） |
| 30 dB   | 1.9 | 1.9 | 2.0 | 2.0 | ❌ 失败（stem: `20260326_163522_...`） |
| 25 dB   | —   | —   | —   | —   | 跳过（30 dB 已失败，无需继续） |
| 20 dB   | —   | —   | —   | —   | 跳过 |

- [x] 完成各增益下的捕获测试，填写结果表格
- [x] 找到捕获失败的临界 tx_gain 值：**30~35 dB 之间**

**结论**：4 颗 PRN 叠加、10ms 积分、amplitude=0.5 时，可靠捕获所需 `tx_gain ≥ 35 dB`。
tx_gain=30 dB 次峰比约 2.0，距门限 2.5 差约 **+2 dB**，再提升 5 dB 即可过门限。
